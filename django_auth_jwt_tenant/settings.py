...
JWT_ENCODE_HANDLER = import_from_string(getattr(
    settings,
    'JWT_ENCODE_HANDLER',
    'django_auth_jwt_tenant.utils.jwt_encode_handler')
)

JWT_DECODE_HANDLER = import_from_string(getattr(
    settings,
    'JWT_DECODE_HANDLER',
    'django_auth_jwt_tenant.utils.jwt_decode_handler')
)

JWT_PAYLOAD_HANDLER = import_from_string(getattr(
    settings,
    'JWT_PAYLOAD_HANDLER',
    'django_auth_jwt_tenant.utils.jwt_payload_handler')
)

JWT_PAYLOAD_GET_USER_ID_HANDLER = import_from_string(getattr(
    settings,
    'JWT_PAYLOAD_GET_USER_ID_HANDLER',
    'django_auth_jwt_tenant.utils.jwt_get_user_id_from_payload_handler')
)
